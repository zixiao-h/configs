...
alias aeons="cd ~/Documents/III/project; source env/bin/activate; ls"
alias open="xdg-open"
alias n="nvim"
alias aeons_venv="source ~/Documents/III/project/env/bin/activate"
alias tc="rm *.aux *.fdb_latexmk *.fls *.log *.synctex.gz *.bbl *.out *.blg"
alias f="zathura --fork"
